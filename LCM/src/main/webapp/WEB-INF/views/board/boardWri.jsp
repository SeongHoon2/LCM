...
$(document).ready(function(){
	...
	$("#boardConDiv_botWriBtn").on("click", function(){
		...
		if(titleTxt==""){
			...
			if(conTxt==""){
				...
				$("#boardCon").val(conTxt);
				var confirmBoard = confirm("글을 작성하시겠습니까?");
			    if(confirmBoard) {
					boardWrite();
			    }
			}
	...
	$("#boardConDiv_botBakBtn").on("click", function(){
		var confirmBoard = confirm("작성중인 글을 취소하시겠습니까?\n작성취소 시 글은 저장되지 않습니다.");
	    if(confirmBoard) {
			history.back();
	    }
	});
	...
	<div class="contentWrapDiv">
		<div class="boardDiv">
			...
			<div class="boardConDiv_bot">
				<input type="button" value="작성" id="boardConDiv_botWriBtn" class="boardConDiv_botBtn"/>
