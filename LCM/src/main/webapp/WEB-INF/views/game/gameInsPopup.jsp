...
<link rel="stylesheet" href="/resources/css/game/gameInsPopup.css">
<link href="source/img/logo/favicon.png" sizes="16x16" rel="shortcut icon" type="image/x-icon">
<script src="https://code.jquery.com/jquery-3.4.1.js" integrity="sha256-WpOohJOqMqqyKL9FccASB9O0KwACQJpFTUBLTYOVvVU=" crossorigin="anonymous"></script>
<script type="text/javascript" src="/resources/js/game/gameInsPopup.js"></script>
...
$(document).ready(function(){
	...
	$("#insGameBtn").on("click", function(){
		if($("#kTxt").val()==""){
			...
			var confirmChk = confirm('경기 데이터를 등록하시겠습니까?');
		    if(confirmChk) {
				insGameData();
		    }
		}
